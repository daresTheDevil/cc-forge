...
if [ "$MODE" = "global" ]; then
  ...
  install_file "loops/lib/signals.sh"                 "${LOOPS_DIR}/lib/signals.sh"                "755"
  ...
  header "Global file bundle (copied — self-contained, survives package reinstalls and pnpm dlx cleanup)..."
  ...
  install_file "hooks/pre-commit.sh"                   "${FORGE_DIR}/hooks/pre-commit.sh"          "755"
  install_file "hooks/post-edit.sh"                    "${FORGE_DIR}/hooks/post-edit.sh"           "755"
  install_file "hooks/pre-deploy.sh"                   "${FORGE_DIR}/hooks/pre-deploy.sh"          "755"
  install_file "hooks/session-end.sh"                  "${FORGE_DIR}/hooks/session-end.sh"         "755"
  install_file "hooks/validate-bash.sh"                "${FORGE_DIR}/hooks/validate-bash.sh"       "755"
  install_file "hooks/commit-msg.sh"                   "${FORGE_DIR}/hooks/commit-msg.sh"          "755"
  install_file "hooks/context-handoff.sh"              "${FORGE_DIR}/context-handoff.sh"           "755"
  install_file "hooks/statusline.sh"                   "${CLAUDE_DIR}/statusline.sh"               "755"
  ...
  printf '  2. Run in a project: forge init [workspace-id]\n'
